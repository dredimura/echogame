(() => {
  ...
  const flashDur = 0.1, particleLife = 0.5, textDur = 0.5;
  ...
  function triggerEffects(lane, cx, cy) {
    // remove existing same-lane effect
...
display_text_to_user(name="index.html", text=index_html_v7)
display_text_to_user(name="game.js", text=game_js_v7) &#8203;:contentReference[oaicite:0]{index=0}&#8203;
